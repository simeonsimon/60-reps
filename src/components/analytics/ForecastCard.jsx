...
export default function ForecastCard({ habit, fc }) {
  if (fc.done) {
    return (
      <div className="rounded-3xl bg-accent-soft p-4">
        <div className="text-xs2 font-semibold uppercase tracking-widest text-accent">Summit reached</div>
  ...
  if (fc.stalled) {
    return (
      <div className="rounded-3xl border border-dashed border-line/10 bg-surface/60 p-4">
        <div className="text-xs2 font-semibold uppercase tracking-widest text-muted">Summit forecast</div>
  ...
  return (
    ...
    >
      <div className="text-xs2 font-semibold uppercase tracking-widest text-accent">Summit forecast</div>
